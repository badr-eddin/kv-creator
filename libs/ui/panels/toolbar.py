...
from ...pyqt import QPushButton, QSize, Qt, QHBoxLayout, QFrame, QTimer, QIcon, QSpacerItem, QSizePolicy
from ...utils import import_, settings, set_layout, debug
from ...kivy import get_kivy_window_id
...
class ToolBar:
    ...
    def initialize(self, _p=None):
        for _b in sorted(self.buttons.keys()):
            ...
            btn = ToolBarButton(self.ui, obj.get("function"), self)
            # btn.setText(_b)
